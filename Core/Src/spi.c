...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = ECAT_SCK_Pin|ECAT_MOSI_Pin|ECAT_MISO_Pin;
  ...
  */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = CHARGER_SCK_Pin|CHARGER_MISO_Pin|CHARGER_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, ECAT_SCK_Pin|ECAT_MOSI_Pin|ECAT_MISO_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, CHARGER_SCK_Pin|CHARGER_MISO_Pin|CHARGER_MOSI_Pin);
