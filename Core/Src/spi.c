...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = TOF_MISO_Pin|TOF_NCS_Pin|TOF_SCK_Pin|TOF_MOSI_Pin;
  ...
  */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = LDC_SCK_Pin|LDC_MISO_Pin|LDC_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = IMU_MISO_Pin|IMU_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PE4     ------> SPI4_NSS
    */
    GPIO_InitStruct.Pin = ECAT_MOSI_Pin|ECAT_MISO_Pin|ECAT_SCK_Pin|ECAT_NCS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PA0     ------> SPI6_NSS
    */
    GPIO_InitStruct.Pin = CHARGER_MOSI_Pin|CHARGER_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = CHARGER_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI6;
    HAL_GPIO_Init(CHARGER_SCK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CHARGER_NCS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI6;
    HAL_GPIO_Init(CHARGER_NCS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, TOF_MISO_Pin|TOF_NCS_Pin|TOF_SCK_Pin|TOF_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, LDC_SCK_Pin|LDC_MISO_Pin|LDC_MOSI_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOC, IMU_MISO_Pin|IMU_SCK_Pin);

    HAL_GPIO_DeInit(IMU_NCS_GPIO_Port, IMU_NCS_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE4     ------> SPI4_NSS
    */
    HAL_GPIO_DeInit(GPIOE, ECAT_MOSI_Pin|ECAT_MISO_Pin|ECAT_SCK_Pin|ECAT_NCS_Pin);
  ...
  /* USER CODE END SPI6_MspDeInit 0 */
    ...
    PA0     ------> SPI6_NSS
    */
    HAL_GPIO_DeInit(GPIOB, CHARGER_MOSI_Pin|CHARGER_MISO_Pin);

    HAL_GPIO_DeInit(CHARGER_SCK_GPIO_Port, CHARGER_SCK_Pin);

    HAL_GPIO_DeInit(CHARGER_NCS_GPIO_Port, CHARGER_NCS_Pin);
