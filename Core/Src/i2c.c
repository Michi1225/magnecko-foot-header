...
void MX_I2C3_Init(void)
{
  ...
  hi2c3.Instance = I2C3;
  hi2c3.Init.Timing = 0x10B01025;
  hi2c3.Init.OwnAddress1 = 254;
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    PC11     ------> I2C5_SCL
    */
    GPIO_InitStruct.Pin = SENS_LS_SDA_Pin|SENS_LS_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /* I2C5 DMA Init */
    /* I2C5_RX Init */
    hdma_i2c5_rx.Instance = DMA1_Stream4;
    ...
    __HAL_LINKDMA(i2cHandle,hdmarx,hdma_i2c5_rx);

    /* I2C5_TX Init */
    hdma_i2c5_tx.Instance = DMA1_Stream5;
    ...
    __HAL_LINKDMA(i2cHandle,hdmatx,hdma_i2c5_tx);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(LED_SCL_GPIO_Port, LED_SCL_Pin);

    HAL_GPIO_DeInit(LED_SDA_GPIO_Port, LED_SDA_Pin);
  ...
  /* USER CODE END I2C5_MspDeInit 0 */
    ...
    PC11     ------> I2C5_SCL
    */
    HAL_GPIO_DeInit(SENS_LS_SDA_GPIO_Port, SENS_LS_SDA_Pin);

    HAL_GPIO_DeInit(SENS_LS_SCL_GPIO_Port, SENS_LS_SCL_Pin);
