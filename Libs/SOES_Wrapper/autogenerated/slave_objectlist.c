...
static const char acName1A03_0B[] = "Current Actual";
...
static const char acName200E_03[] = "Uq";
static const char acName200E_04[] = "Ud";
...
static const char acName2012[] = "Encodre Offset Calibrated";
static const char acName2013[] = "Special Command";
...
static const char acName6078[] = "Current Actual";
...
const _objd SDO1603[] =
{
  {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName1603_00, 9, NULL},
...
const _objd SDO1A03[] =
{
  {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName1A03_00, 11, NULL},
...
const _objd SDO2000[] =
{
  ...
  {0x01, DTYPE_UNSIGNED16, 16, ATYPE_RO, acName2000_01, 0, &Obj.Device_Information[0]},
  {0x02, DTYPE_UNSIGNED16, 16, ATYPE_RO, acName2000_02, 0, &Obj.Device_Information[1]},
  {0x03, DTYPE_UNSIGNED16, 16, ATYPE_RO, acName2000_03, 0, &Obj.Device_Information[2]},
  {0x04, DTYPE_UNSIGNED16, 16, ATYPE_RO, acName2000_04, 0, &Obj.Device_Information[3]},
  {0x05, DTYPE_UNSIGNED16, 16, ATYPE_RO, acName2000_05, 0, &Obj.Device_Information[4]},
  {0x06, DTYPE_UNSIGNED16, 16, ATYPE_RO, acName2000_06, 0, &Obj.Device_Information[5]},
  {0x07, DTYPE_UNSIGNED16, 16, ATYPE_RO, acName2000_07, 0, &Obj.Device_Information[6]},
};
const _objd SDO2001[] =
{
...
const _objd SDO200E[] =
{
  {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName200E_00, 4, NULL},
  {0x01, DTYPE_REAL32, 32, ATYPE_RO, acName200E_01, 0x00000000, &Obj.Internal_Info.Iq},
  {0x02, DTYPE_REAL32, 32, ATYPE_RO, acName200E_02, 0x00000000, &Obj.Internal_Info.Id},
  {0x03, DTYPE_REAL32, 32, ATYPE_RO, acName200E_03, 0x00000000, &Obj.Internal_Info.Uq},
  {0x04, DTYPE_REAL32, 32, ATYPE_RO, acName200E_04, 0x00000000, &Obj.Internal_Info.Ud},
};
const _objd SDO200F[] =
{
...
const _objd SDO2010[] =
{
  ...
  {0x01, DTYPE_BOOLEAN, 1, ATYPE_RW | ATYPE_RXPDO, acName2010_01, 0, &Obj.GPIO_Toggle[0]},
  {0x02, DTYPE_BOOLEAN, 1, ATYPE_RW | ATYPE_RXPDO, acName2010_02, 0, &Obj.GPIO_Toggle[1]},
};
const _objd SDO2011[] =
{
  {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName2011_00, 2, NULL},
  {0x01, DTYPE_BOOLEAN, 1, ATYPE_RW | ATYPE_TXPDO, acName2011_01, 0, &Obj.GPIO_State[0]},
  {0x02, DTYPE_BOOLEAN, 1, ATYPE_RW | ATYPE_TXPDO, acName2011_02, 0, &Obj.GPIO_State[1]},
};
const _objd SDO2012[] =
{
  {0x0, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName2012, 0, &Obj.Encodre_Offset_Calibrated},
};
const _objd SDO2013[] =
{
  {0x0, DTYPE_UNSIGNED16, 16, ATYPE_RW, acName2013, 0, &Obj.Special_Command},
};
const _objd SDO2014[] =
{
...
const _objd SDO6062[] =
{
  {0x0, DTYPE_INTEGER32, 32, ATYPE_RO, acName6062, 0, &Obj.Position_Demand},
};
const _objd SDO6064[] =
{
...
const _objd SDO606B[] =
{
  {0x0, DTYPE_INTEGER32, 32, ATYPE_RW | ATYPE_TXPDO, acName606B, 0, &Obj.Velocity_Demand},
};
const _objd SDO606C[] =
{
...
const _objd SDO6074[] =
{
  {0x0, DTYPE_INTEGER16, 16, ATYPE_RW | ATYPE_TXPDO, acName6074, 0, &Obj.Torque_Demand},
};
const _objd SDO6077[] =
{
...
const _objd SDO6078[] =
{
  {0x0, DTYPE_INTEGER32, 32, ATYPE_RO | ATYPE_TXPDO, acName6078, 0, &Obj.Current_Actual},
};
const _objd SDO6079[] =
{
  {0x0, DTYPE_UNSIGNED32, 32, ATYPE_RO | ATYPE_TXPDO, acName6079, 0, &Obj.DC_Link_Voltage},
};
const _objd SDO607A[] =
{
...
const _objectlist SDOobjects[] =
{
  ...
  {0x1603, OTYPE_RECORD, 9, 0, acName1603, SDO1603},
  {0x1A03, OTYPE_RECORD, 11, 0, acName1A03, SDO1A03},
  ...
  {0x200E, OTYPE_RECORD, 4, 0, acName200E, SDO200E},
