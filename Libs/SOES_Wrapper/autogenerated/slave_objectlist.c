...
const _objd SDO60C0[] =
{
  ...
  {0x01, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_01, 0, &Obj.HALL_Mag_X[0]},
  {0x02, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_02, 0, &Obj.HALL_Mag_X[1]},
  {0x03, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_03, 0, &Obj.HALL_Mag_X[2]},
  {0x04, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_04, 0, &Obj.HALL_Mag_X[3]},
  {0x05, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_05, 0, &Obj.HALL_Mag_Y[0]},
  {0x06, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_06, 0, &Obj.HALL_Mag_Y[1]},
  {0x07, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_07, 0, &Obj.HALL_Mag_Y[2]},
  {0x08, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_08, 0, &Obj.HALL_Mag_Y[3]},
  {0x09, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_09, 0, &Obj.HALL_Mag_Z[0]},
  {0x0A, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_0A, 0, &Obj.HALL_Mag_Z[1]},
  {0x0B, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_0B, 0, &Obj.HALL_Mag_Z[2]},
  {0x0C, DTYPE_UNSIGNED16, 16, ATYPE_RO | ATYPE_TXPDO, acName60C0_0C, 0, &Obj.HALL_Mag_Z[3]},
};
